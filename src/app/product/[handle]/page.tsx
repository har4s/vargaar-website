            ...
            <div className={s.Container}>
                <div className={s.text}>
                    ...
                    <span className={s.subtitle}>
                        برای مصرف بدون اعتدال!
                    </span>
                    <div className={s.content}>
                        <p>
                            کاسنی محلول در طبیعت ارگانیک را کشف کنید. تداعی کننده طعم و مزه طبیعی خوب، انتظارات شما را با نیت چشیدن یک محصول سازگار با محیط زیست با منشاء 100٪ گیاهی برآورده می کند.                        </p>
                    </div>
